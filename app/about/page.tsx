  ...
  return (
    <main className="px-6 py-10 text-slate-950">
      <div className="mx-auto flex max-w-6xl flex-col gap-10">
        <div className="absolute -right-10 top-8 h-40 w-40 rounded-full bg-sky-200/50 blur-3xl" />
        <div className="absolute left-0 top-full h-32 w-32 -translate-y-1/2 rounded-full bg-amber-200/50 blur-3xl" />
